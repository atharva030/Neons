...
const HomeScreen = ({ navigation }) => {
    ...
    const addTeam = async () => {
        fetch('http://192.168.137.109:8888/api/team/createteam', {
            method: 'POST',
            headers: {
    ...
    const editTeam = async (teamId) => {
        ...
        console.log(teamId);
        fetch(`http://192.168.137.109:8888/api/team/updateteam/${teamId}`, {
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/json',
          },
    ...
    const fetchTeam = async () => {
        // console.log("Hey")
        fetch('http://192.168.137.109:8888/api/team/fetchallteams', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'auth-token': "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiNjQ0NDExNWE4OWM2YzBkNWVkM2NkZjk1In0sImlhdCI6MTY4NDUxMzMxNn0.jSfavFDUHDr0Kc4AB-nj6ySuuaB04b7tuQEgHKBo1og",
